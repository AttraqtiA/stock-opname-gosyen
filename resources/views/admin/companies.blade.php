    ...
    <header class="border-b border-[var(--line)] bg-[var(--header)]">
        <div class="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4">
            <div>
                ...
                <h1 class="text-xl font-bold text-[var(--text)]">Client Companies</h1>
            </div>
            <div class="flex gap-2">
                <a href="{{ route('admin.users') }}" class="rounded-md border border-[var(--line)] px-3 py-2 text-sm font-bold text-[var(--text)]">Akun</a>
